...
if __name__ == "__main__":
    ...
    parser.add_argument("--predictions", type=str, default='stuff/predictions_VC-JHJ_Woman_40s-01-08-35.48_test.txt')
    parser.add_argument("--references", type=str, default='stuff/references_VC-JHJ_Woman_40s-01-08-35.48_test.txt')
