...
target_dataset = 'dataset/13_CUJ_Woman'
dataset_path = f'{target_dataset}/{test_name}.json'
adapter_name = 'ghost613/VC-13_CUJ_Woman-large-lora'
revision = None
...
peft_config = PeftConfig.from_pretrained(adapter_path, revision=revision)
