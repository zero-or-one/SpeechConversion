...
# /START SETUP
speakers = ['BMG_Woman_50s',  'CYR_Woman_50s',  'JHJ_Woman_40s',  'KGH_Woman_30s',  
            'LJM_Man_30s',  'MJY_Woman_40s',  'MSY_Woman_40s',  'YEJ_Woman_40s']
...
repo_name = f'VC-all-{train_duration_str}'
